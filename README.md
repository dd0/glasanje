...
1. Иди до алатке на [https://cuserbsoc.soc.srcf.net/glasanje/](https://cuserbsoc.soc.srcf.net/glasanje/)
...
Сајт просто додаје ваше унете податке на празан формулар за пријаву за гласање у инострантсву [(овде)](https://github.com/dd0/glasanje/blob/master/src/assets/Zahtev-za-glasanje-u-inostranstvu-2022.pdf). **Подаци су код вас, у вашем уређају и нестају чим затворите сајт или када направите попуњен захтев.**
...
- **Уместо сајта који наводе у упутству, користите https://cuserbsoc.soc.srcf.net/glasanje/**
